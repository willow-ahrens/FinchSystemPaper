...
\subsection{Concordization}
    ...
    \begin{figure}[htbp]
        ...
        \begin{minted}[fontsize=\scriptsize, breaklines]{julia}
        for i = _
            for j = _
                for k = _
                    s[] += A[i, k, j]
        ...
        \caption{Transformations demonstrating concordization of unrecognized index expressions.\saman{not clear to me what is going on.}}
        \end{figure}
