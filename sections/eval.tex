...
\begin{align*}
    ...
    \finchrelabel(expr, idxs...) \quad\quad\quad \finchmapjoin(op, exprs...) \quad\quad\quad \\
    \finchaggregate(op, expr)\quad\quad\quad \finchtable(tns, idxs...)  \quad\quad\quad\quad\quad \finchalias(name) \quad\quad\\
...
\end{align*}
Notably, these plans do not specify 
