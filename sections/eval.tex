...
\begin{table}[htbp]
    ...
    \begin{tabular}{|l|l|l|l|l|}
        \hline
        \textbf{Outer Level} & \textbf{Inner Level} & \textbf{Scalar Values} & \textbf{Style of Matrix} & \textbf{Evaluation Datasets} \\
        \hline
        \multirow{2}{*}{Dense} & \multirow{2}{*}{SparseList} & Element & sparse matrices & Vuduc, Ahrens, TACO, SNAP, synthetic 
        \hline 
    \end{tabular}
    \footnotesize *Used in conjunction with aforementioned formats as the innermost level to represent scalar values.
\end{table}
