...
\begin{table}[htbp]
    ...
    \begin{tabular}{|l|l|l|}
        ...
        \hline
        SparseList & sparse matrices & Vuduc, Ahrens, TACO, synthetic \\
        \hline
        SparseVBL & matrices with a clear blocked structure & Vuduc, Ahrens, TACO, synthetic  \\
        \hline 
        SparseBand & matrices with a diagonal band & Vuduc, Ahrens, TACO, synthetic \\ 
        \hline 
        SparsePoint & matrices with one value per row & synthetic \\
        \hline
        Pattern* & matrices with boolean values & SNAP collection \\
        \hline 
        \footnote{test}
    \end{tabular}
\end{table}
