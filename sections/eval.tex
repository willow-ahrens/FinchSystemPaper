...
\begin{tabular}{p{0.33\textwidth} p{0.33\textwidth} p{0.33\textwidth}}
  ...
  \vspace{0pt} \includegraphics[width=145pt, height=120pt]{figures/elementwise_speedup_over_duckdb.png}
\end{tabular}
