...
\begin{align*}
    ...
    \finchreformat(expr, format) \quad\quad\quad \finchrelabel(expr, idxs...) \quad\quad\quad \finchmapjoin(op, exprs...) \\
    \finchaggregate(op, expr)\quad\quad\quad\quad \finchtable(tns, idxs...)  \quad\quad\quad\quad\quad\quad \finchalias(name) \quad\quad\\
     expr:= \finchreorder | \finchrelabel |\finchmapjoin | \finchaggregate | \finchtable | \finchalias \quad\quad\quad\quad\quad
\end{align*}
