...
Note that inner-product is very inefficient unless sparse matrices are nearly dense because the cost of intersections that incurs a lot of redundant computations. For the output-product, TATACO does not support outer product due to its lack of support for scatter into a 2D workspace.  
