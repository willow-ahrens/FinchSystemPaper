...
\begin{figure}
	\includegraphics[width=.3\linewidth]{triangle_count_speedup_over_duckdb.png}
	\includegraphics[width=.35\linewidth]{sddmm_speedup_over_duckdb.png}
	\includegraphics[width=.3\linewidth]{elementwise_speedup_over_duckdb.png}
