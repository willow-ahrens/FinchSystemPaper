...
The logical language takes inspiration from relational algebra while incorporating the ordered nature of dimensions in sparse tensors. This means that ev
