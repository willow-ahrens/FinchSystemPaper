...
\begin{table}[htbp]
    ...
    \begin{tabular}{|l|l|l|l|}
        ...
        \hline
        \multirow{7}{*}{Dense} & \multirow{2}{*}{SparseList} & Element & sparse, real-valued matrices \\
        \cline{3-4} 
        & & Pattern & sparse, boolean-valued matrices \\
        \cline{2-4} 
        & \multirow{2}{*}{SparseVBL} & Element & real-valued matrices with blocked structure \\
        \cline{3-4} 
        & & Pattern & boolean-valued matrices with blocked structure \\
        \cline{2-4}
        & \multirow{2}{*}{SparseBand} & Element & real-valued matrices with diagonal band \\
        \cline{3-4} 
        & & Pattern & boolean-valued matrices with diagonal band \\
        \cline{2-4}
        & \multirow{2}{*}{SparsePoint} & Element & real-valued matrices with one value per row \\
        \cline{3-4} 
        & & Pattern & boolean-valued matrices with one value per row \\
        \hline 
    \end{tabular}
