...
\begin{table}[htbp]
    ...
    \begin{tabular}{|l|l|l|l|}
        ...
        \cline{2-4} 
        & \multirow{2}{*}{SparseVBL} & Element & real-valued matrices with a blocked structure \\
        \cline{3-4} 
        & & Pattern & boolean-valued matrices with a blocked structure \\
        \cline{2-4}
        & \multirow{2}{*}{SparseBand} & Element & real-valued matrices with a diagonal band \\
        \cline{3-4} 
        & & Pattern & boolean-valued matrices with a diagonal band \\
        \hline 
    \end{tabular}
