...
As shown in Figure~\ref{spgemm_small}, for inner-product, Finch achieves comparable performance with TACO, and for outer-product, teh
As shown in Figure~\ref{spgemm_large}, for large sparse matrices, Finch outperforms TACO with an average speedup of 1.05.
