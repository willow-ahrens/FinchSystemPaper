...
% \end{multline*}
    ...
    \begin{prooftree}
    \hypo{s = (e, t, d)}
    \hypo{\langle term_{0}, (e, t, \{\}) \rangle \rightarrow s_{1}}
    \hypo{\langle term_{1}, s_{1} \rangle \rightarrow s_{2}}
    \hypo{\dots}
    \hypo{\langle term_{n-1}, s_{n-1} \rangle \rightarrow s_{n}}
    \hypo{s_{n}= (e^{\prime}, t^{\prime}, d^{\prime})}
        \infer6[$Block$]{\langle\finchblock(term_{0}, \dots, term_{n}), s \rangle \rightarrow (e^{\prime}, t^{\prime}, d) }
    \end{prooftree}
    \hfill
