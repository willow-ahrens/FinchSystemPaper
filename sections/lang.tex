...
\begin{figure}
    ...
    \hypo{e(tns) = tns'}
    \infer3{\langle\finchthaw(tns), s\rangle \rightarrow (e [\finchmode(tns) \mapsto update], \langle thaw(tns'), t \rangle)}
    \end{prooftree}
    \hfill
    \vspace{2em}
    ...
    \hypo{e(tns) = tns'}
    \infer3{\langle\finchfreeze(tns), (e, t)\rangle \rightarrow (e [\finchmode(tns) \mapsto read], \langle freeze(tns'), t \rangle)}
    \end{prooftree}
      \vspace{2em}
    ...
    \hypo{s = (e, t)}
    \hypo{tns\not\in e}
    \hypo{\langle init, s \rangle \Rightarrow v}
    \hypo{\forall d_{i}\in dims, \langle init, d_{i} \rangle \Rightarrow v_{i}}
    \infer4{\langle\finchdeclare(tns, init, dims), (e, t)\rangle \rightarrow (e [\finchmode(tns) \mapsto update], \langle \finchdeclare(tns, v, v_{0}, \dots)), t \rangle)}
    \end{prooftree}
...
\begin{figure}
    ...
    \rightarrow val'}
    \infer1{\langle\finchdefine(var, val, body), (e, t)\rangle \rightarrow \langle body, (e[var \mapsto val'], t) \rangle}
    \end{prooftree}
    \vspace{2em}
