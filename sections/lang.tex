...
\begin{figure}
    ...
    \caption{Lifecycle evaluation semantics. The state $s$ of the finch compiler
    is a tuple $(e, t)$ of a variable value environment and another state $t$
    corresponding to the state in the host language. All of the lifecycle
...
\end{prooftree}
    ...
    language.  Note that $E$ is an evaluation context that applies anywhere in
