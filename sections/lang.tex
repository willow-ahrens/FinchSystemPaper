...
Our syntax is highly permissive: by allowin blocks of code with multiple statements, we support both multiple outputs and temporary tensors, seen most prominently in our implementation of gustavson's algorithm for sparse-sparse matrix multiply and breadth-first-search.
%
