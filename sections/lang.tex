...
Though the reader may doubt the coverage of this approach, the next section will detail how the compiler adds additional features on top of this core language ultimately through the assurance that accesses to tensor values will first unravel to Looplets and then simplify in the context of the location of the access.
%
