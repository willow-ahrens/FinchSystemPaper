...
% \end{multline*}
    ...
    \begin{prooftree}
    \hypo{s = (e, t, d)}
    \hypo{\langle head, (e, t, \{\}) \rangle \rightarrow s^{\prime}}
    \hypo{\langle \finchblock(tail...), s^{\prime} \rangle \rightarrow (e^{\prime}, t^{\prime}, d^{\prime})})
        \infer3[$BlockHead$]{\langle\finchblock(head, tail...), s \rangle \rightarrow (e^{\prime}, t^{\prime}, d) }
    \end{prooftree}
    \hfill
