...
%
For example, Finch has been extended to support real-valued array indices with continuous arrays \cite{anonymous_authors_continuous_2024}. Finch is also used as a compiler backend for the Python PyData/Sparse library \cite{abbasi_plans_2023}.
%
