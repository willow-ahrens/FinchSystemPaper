...
paszke_pytorch_2019,ragan-kelley_halide_2013}\saman{Put these citations next to each language - otherwise associated with the breakthroughs...}.
% EASY CUT
...
loop-carry-dependencies, and more. Several\saman{myriad of} optimizations have been developed for
...
contractions \cite{kjolstad_tensor_2019, hu_taichi_2019, ghorbani2023compiling, fegade_cora_2022}. \saman{when you cite multiple projects, put the citations next to each project.}
%
