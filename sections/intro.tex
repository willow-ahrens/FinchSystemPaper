...
\teo{ New paragraph:
%
Many of these special purpose compilers represent a program's control flow via a specialized data structure that is tightly integrated with a narrow class of supported data structures.
%
